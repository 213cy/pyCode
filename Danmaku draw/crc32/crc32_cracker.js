// https://github.com/qianjiachun/bilibili-danmaku-tracker/blob/main/dist/index.js
...
function measureExecutionTime(par) {
    const startTime = new Date().getTime();
    r = uhash2uid(par); // 调用传入的函数
...
measureExecutionTime('83dcefb7')

measureExecutionTime('8bcda38e')

measureExecutionTime('efb3f424')
